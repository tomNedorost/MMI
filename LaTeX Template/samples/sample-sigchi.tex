...
We wanted to find out if the gender itself plays an important role in the acceptance of such devices in general. Both genders have been tested without using any VR tools to get a baseline for upcoming steps and procedures, the actors using a smartphone instead for the baseline.
